                    ...
                    if(isset($_SESSION['uname'])) {
                        if(isset($_GET['username']) && ($_GET['username'] == $_SESSION['uname'])) {
                            ...
                            echo '<form id="form-schimba-poza" action="imagine-profil.php" method="post" enctype="multipart/form-data">
                                    ...
                                    <button style="margin-top:1.5%" class="btn btn-primary" type="submit" name="submit">Schimba</button>
                                </form>';
                                if(isset($_GET['ie'])) {
                                    if($_GET['ie'] == "success") {
                            ...
                            echo '<form id="form-schimba-parola" action="schimba-parola.php" method="post">
                                        <div><label class="label-schimba-parola" for="parola-curenta">Parola curenta:</label><input class="form-control" style="max-width:200px" type="password" name="parola-curenta" value="" placeholder="Parola curenta" style="margin-right: 2%;"></div>
                                        <div><label class="label-schimba-parola" for="parola-noua">Parola noua:</label><input class="form-control" style="max-width:200px" type="password" name="parola-noua" value="" placeholder="Parola noua" style="margin-right: 2%;">Parola trebuie sa aiba minim 8 caractere, o litera mare, o cifra</div>
                                        <div><label class="label-schimba-parola" for="parola-noua-c">Confirma parola:</label><input class="form-control" style="max-width:200px" type="password" name="parola-noua-c" value="" placeholder="Confirma noua parola" style="margin-right: 2%;"></div>
                                        <button class="btn btn-primary" type="submit" name="submit">Schimba parola</button>
                                    </form>';
                            if(isset($_GET['sp'])) {
                                if($_GET['sp'] == "success") {
                            ...
                            echo '<form id="form-schimba-email" action="schimba-email.php" method="post">
                                        <div><label class="label-schimba-email" for="email-nou">Adresa noua:</label><input  class="form-control" style="max-width:200px" type="text" name="email-nou" value="" placeholder="Email" style="margin-right: 2%;"></div>
                                        <div><label class="label-schimba-email" for="parola-curenta">Parola curenta:</label><input class="form-control" style="max-width:200px" type="password" name="parola-curenta" value="" placeholder="Parola curenta" style="margin-right: 2%;"></div>
                                        <div><label class="label-schimba-email" for="parola-curenta-c">Confirma parola:</label><input class="form-control" style="max-width:200px" type="password" name="parola-curenta-c" value="" placeholder="Confirma parola" style="margin-right: 2%;"></div>
                                        <button class="btn btn-primary" type="submit" name="submit">Schimba email</button>
                                    </form>';
                            if(isset($_GET['se'])) {
                                if($_GET['se'] == "success") {
