...
<?php include "includes/head.php";?>
        ...
        #img-produs {
            ...
            "container-produs container-produs container-produs"
            "container-similare container-similare container-similare";    
                 }
                 .container-produs {
                     margin: 0;
                     border: 0;
                        ...
                        if($result->num_rows == 1) {
                          ...
                          if(isset($_SESSION['uid'])) {
                              ...
                              echo     '<form id="form-comentariu-produs" action="adauga-comentariu-produs.php" method="post">
                                          ...
                                          <textarea style = "max-width:500px" class="form-control" name="comentariu-produs" rows="10" cols="5" placeholder="Comentariu" style="resize: none;"></textarea><br/>
                                        ...
                                        echo          '</div>
                                                   <div class="box-body-prod">
                                                      ...
                                                      <div class="actiune-prod">
                                                          <button class="btn btn-primary" id="' . $line["produs_cod"] . '" class="btn-cart">
