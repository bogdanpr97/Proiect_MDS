...
<?php include "includes/head.php";?>
		...
		$(document).ready(function () {
            ...
            $("#search-produse").on("input", function() {
                ...
                if(searchVal == "") {
                    $(".produse-big-box").load("generare-produse-all.php", {"pn" : 1});
                } else {
                    $(".produse-big-box").load("generare-produse-all.php", {"search" : searchVal, "pn" : 1});
                }
            })
			...
			select_P = function() {
                if($("#search-produse").val() == "") {
    				...
    				$(".produse-big-box").load("generare-produse-all.php", {"pn" : pagina});
                } else {
                    var searchVal = $("#search-produse").val();
                    var pagina = parseInt($("#select_pagP").val());
    				$(".produse-big-box").load("generare-produse-all.php", {"search" : searchVal, "pn" : pagina});
                }
			}
        ...
        .produs-box a {
            ...
            color: var(--dark);
             ...
             @media screen and (max-width:760px) {
                 .wrapper-produse {
                 grid-template-areas:
                "wrapper-side wrapper-side wrapper-side"
                "container-produse container-produse container-produse";
                 }
                 .container-produse {
                     border: 0;
                     margin: 0;
        ...
        <div class="container-produse">
            <h2 id="titlu-produse">Toate produsele</h2>
