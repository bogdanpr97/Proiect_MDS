...
<head>
    ...
    <style>
        ...
        .wrapper {
            ...
            grid-template-areas:
            "account-box account-box account-box account-box"
	                        ...
	                        //while($row = $result->fetch_assoc()) {
								...
								if(isset($_SESSION['uid'])) {
									...
									echo     '<form id="form-comentariu-articol" action="adauga-comentariu-articol.php" method="post">
												...
												<textarea name="comentariu-articol" rows="10" cols="50" placeholder="Comentariu" style="resize: none;"></textarea><br/>
